...
\section{Galatic setup}
	...
	\subsection{Dynamical friction}
		...
		\begin{equation}
			a_\text{DF}^\text{DM}(r, v) = - \dfrac{4\pi G^2}{v^2}M_\bullet\rho(r) \times \ln \Lambda\left(\erf{X} - \dfrac{2}{\sqrt{\pi}}Xe^{-X^2}\right)\hat{v}
		\end{equation}
		\begin{equation}
			X \equiv \dfrac{|v|}{\sqrt{2}\sigma_\text{DM}} \qquad \text{with } \sigma_\text{DM}(r) = \sqrt{\dfrac{GM_\text{DM}(r)}{2R_\text{vir}}}
		\end{equation}
