...
I would like to thank professor \supname{} for his time, patience and dedication, from which without his advice, none of this would be possible. To all the people at AstroAndes, I wish to thank you for the nice talks where this work got richer.
\vspace{1cm}

Also, I would like to thank \texttt{StackOverflow}, \texttt{Python}, \texttt{NumPy}, \text{matplotlib} and \texttt{REBOUND} for making all of your efforts public.
\vspace{1cm}

Lastly, I wish to thank \texttt{GitHub} for permanently hosting this project for free and publicly available at: \url{https://github.com/jsbarbosa/TesisFisica}.
\vspace{1cm}
